...
BUFFER_SIZE = 1000
STEPS_PER_EPOCH = 4
RESERVED_FOR_TRAIN = 2


image_folder_path  = './airbus-ship-detection/train/train_test/images/'
mask_folder_path  = './airbus-ship-detection/train/train_test/masks/'
